...
def ladder_crash_scenario(
    filename: str, type: str, options: List[str], result: bool = True, save_to_file: bool = False
):
...
def ladder_crash_scenario_1():
    ladder_crash_scenario(
        "ladder_crash_scenario_1.json",
        "build",
...
def omit_missing_historial_options():
    ladder_crash_scenario(
        "omit_missing_historial_options.json",
        "build",
